...
//     useEffect(() => {
//     if (preselect) {
//       // optional: show toast or focus cart
//       console.log("Preselected item:", preselect);
//     }
//   }, [preselect]);
...
//             <div className="text-sm opacity-80">{cart.reduce((a, b) => a + b.qty, 0)} items</div>
//           </div>
...
//       {/* Checkout modal / drawer (simple responsive) */}
//       <AnimatePresence>
//         {checkoutOpen && (
//           <motion.div
//             initial={{ opacity: 0 }}
