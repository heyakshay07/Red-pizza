...
//     <div className="min-h-screen bg-gradient-to-b from-red-100 to-red-50 md:p-8">
//       {/* Page Banner */}
...
const NewArrivals = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-100 to-red-50    py-8">
      {/* Hero / Banner */}
      <div className="relative w-full h-[200px] sm:h-[250px] md:h-[400px] mb-8 md:mb-10">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center animate-pulse">
            🍕 New Arrivals 🍕
          </h1>
        </div>
      </div>
      ...
      {/* Pizza Cards Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 md:px-10 max-w-7xl mx-auto">
        {pizzas.map((pizza, index) => (
          <motion.div
            key={pizza.id}
            className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 flex flex-col items-center text-center hover:scale-105 transition-transform cursor-pointer"
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            <img
              src={pizza.image}
              alt={pizza.name}
              className="w-44 sm:w-52 h-auto object-contain mb-4"
            />
            <h2 className="text-lg sm:text-xl font-semibold text-red-600 mb-1 sm:mb-2">
              {pizza.name}
            </h2>
